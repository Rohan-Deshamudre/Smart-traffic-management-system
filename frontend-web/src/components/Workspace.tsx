                        ...
                        <div className="workspace-container">
                            <Query query={GET_TREE} variables={{ id }} skip={!id}>
                                {({ loading, error, data, client }) => {
                                    ...
                                    let deactivatedResponsePlan = undefined;

                                    if (data !== undefined) {
                                        [scenario, deactivatedNodes] = treeUtils.transformData(data.scenarios[0], client);
                                        deactivatedResponsePlan = treeUtils.getDeactivatedResponsePlan(client);
                                            ...
                                            <div className="workspace-content">
                                                {swapped ?
                                                    <Tree.Small rightPaneActive={this.props.rightPaneActive}
                                                        ...
                                                        deactivatedResponsePlan={deactivatedResponsePlan}
                                                        treeLevel={treeLevel}
                                                    />
                                                    :
