...
class Map extends React.PureComponent<Props, State> {
    ...
    configureSelectedRoute() {
        ...
        // mapDisplay.displayDestination(selectedRoute, 'selectedRouteSource', this.map);
    ...
    configureRoadSegment() {
        ...
        // mapDisplay.displayDestination(roadSegmentRoutes, 'roadSegmentRoutesSource', this.map);
    ...
    updateRoadSegments(prevProps: any) {
        ...
        if (!_.isEqual(currentRoadSegmentWayPoints, this.getRoadSegmentWayPoints(prevProps.scenario, false))) {
            ...
            // mapDisplay.displayDestination(currentRoadSegmentRoutes, 'selectedRouteSource', this.map);
