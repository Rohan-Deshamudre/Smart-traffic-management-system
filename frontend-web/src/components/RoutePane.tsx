    ...
    return class asRoutesPane extends React.Component<
        ...
        render() {
            ...
            return (
                <div>
                    {!active ? (
                        <div className="open-pane-button route" onClick={this.props.toggle}>
                            <div className="description">{this.props.paneName}</div>
                            <img src={this.props.icon} alt={""} />
                        </div>
                    ) : null}
                    <div className={(active ? "active-route-pane " : "inactive-route-pane ") + " routepane-container"}>
                        <div className="close-pane-button route" onClick={this.props.toggle}>
