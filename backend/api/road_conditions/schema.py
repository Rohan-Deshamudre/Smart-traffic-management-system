...
class RoadConditionObjectType(DjangoObjectType):
    class Meta:
        model = RoadCondition
        exclude_fields = (
            'road_conditions_road_conditions', 'road_segment_road_condition',)
...
class RoadConditionDateObjectType(DjangoObjectType):
    class Meta:
        ...
        exclude_fields = (
            'road_condition_dates',)


class Query(actions_schema.Query, graphene.ObjectType):
    road_conditions = graphene.List(RoadConditionObjectType,
                                    condition_id=graphene.Int())
    road_condition_types = graphene.List(RoadConditionTypeObjectType,
    ...
    def resolve_road_condition_types(self, info, type_id=None, name=None,
                                     desc=None, **kwargs):
        """
